...
- For the clean activation-based path, the selected rows should already contain:
  ...
  user-trait pipeline.
- If no saved activation file exists, projection should fail instead of
  falling back to text-based projection.
"""
...
from pipeline_utils import resolve_axis_files, run_cmd
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--projection-script", type=str, default="project/text_projection/project_pair_axes.py")
